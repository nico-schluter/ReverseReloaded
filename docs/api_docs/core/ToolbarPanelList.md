...
**Accessed from:** UserInterface.allToolbarPanels, UserInterface.toolbarPanelsByProductType
...
- **Returns** (ToolbarPanel): Returns the specified ToolbarPanel or null in the case where there isn't a ToolbarPanel with the specified ID.
