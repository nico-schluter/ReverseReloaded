...
**Accessed from:** UserInterface.allToolbarTabs, UserInterface.toolbarTabsByProductType
...
- **Returns** (ToolbarTab): Returns the specified ToolbarTab or null in the case where there isn't a ToolbarTab with the specified ID.
