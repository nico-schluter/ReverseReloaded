...
**Accessed from:** UserInterface.workspaceActivated, UserInterface.workspaceDeactivated, UserInterface.workspacePreActivate, UserInterface.workspacePreDeactivate
...
- **handler** (WorkspaceEventHandler): The handler object to be removed from the event.
