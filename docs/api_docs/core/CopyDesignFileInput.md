...
**Accessed from:** DataFile.createCopyDesignFileInput
...
### isCopyDrawings : boolean [read-write]
Gets and sets if any drawings associated with the design should also be copied.

### isCopyReferencedExternalComponents : boolean [read-write]
...
### targetFolder : DataFolder [read-only]
