...
**Accessed from:** Command.mouseClick, Command.mouseDoubleClick, Command.mouseDown, Command.mouseDrag, Command.mouseDragBegin, Command.mouseDragEnd, Command.mouseMove, Command.mouseUp, Command.mouseWheel
