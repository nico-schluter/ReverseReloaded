...
**Accessed from:** Application.activeProduct, FusionUnitsManager.product, NamedView.parentProduct, Products.item, Products.itemByProductType, RenderManager.parentDesign, UnitsManager.product
