...
**Accessed from:** Application.materialLibraries
...
### item(index: integer) -> MaterialLibrary
...
- **Returns** (MaterialLibrary): Returns the specified material library or null if an invalid index was specified.

### itemById(id: string) -> MaterialLibrary
Returns the Material Library at the specified ID.
- **id** (string): The ID of the library to return.
- **Returns** (MaterialLibrary): Returns the specified material library or null if there's no match on the ID.
...
- **Returns** (MaterialLibrary): Returns the specified material library or null if there's no match on the name.

### load(filename: string) -> MaterialLibrary
...
- **Returns** (MaterialLibrary): Returns the MaterialLibrary object representing the opened library or null in the case of failure.
