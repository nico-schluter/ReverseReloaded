...
**Accessed from:** Command.navigatingURL, Palette.navigatingURL, TextCommandPalette.navigatingURL
...
- **handler** (NavigationEventHandler): The handler object to be removed from the event.
