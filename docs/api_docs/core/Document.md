...
**Accessed from:** Application.activeDocument, CAM.parentDocument, Design.parentDocument, DocumentEventArgs.document, DocumentReference.parentDocument, DocumentReference.referencedDocument, Documents.add, Documents.item, Documents.open, Drawing.parentDocument, FlatPatternProduct.parentDocument, ImportManager.importToNewDocument, MFGDMDataEventArgs.document, Product.parentDocument, Viewport.parentDocument, WorkingModel.parentDocument
