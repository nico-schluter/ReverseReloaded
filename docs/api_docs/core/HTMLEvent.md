...
**Accessed from:** Command.incomingFromHTML, Palette.incomingFromHTML, TextCommandPalette.incomingFromHTML

## Methods

### add(handler: HTMLEventHandler) -> boolean
Add a handler to be notified when the event occurs.
- **handler** (HTMLEventHandler): The handler object to be called when this event is fired.
