...
**Accessed from:** Command.inputChanged

## Methods

### add(handler: InputChangedEventHandler) -> boolean
Adds an event handler to this event endpoint.
- **handler** (InputChangedEventHandler): The client implemented InputChangedEventHandler to be called when this event is triggered.
