...
**Accessed from:** CurveSelections.createNewSilhouetteSelection
...
### sideType : SideTypes [read-write]
Desired side type. The default is StartOutside.

### silhouetteTolerance : double [read-write]
