...
**Accessed from:** CAMLibraryManager.machineLibrary
...
### childMachines(url: URL) -> Machine
Get all machines by the given parent folder URL. Returns null, if the URL does not exist.
- **url** (URL): The URL of the folder to get machines from.
- **Returns** (Machine): Returns the machine for a valid URL, returns null otherwise.
...
This is an optional argument whose default value is "".
- **Returns** (MachineQuery): Returns a new MachineQuery. The query is predefined by given parameter.
...
### importMachine(machine: Machine, destinationUrl: URL, machineName: string) -> URL
...
- **Returns** (URL): Returns the URL of the newly imported machine, or null if the import failed.

### machineAtURL(url: URL) -> Machine
...
### updateMachine(url: URL, machine: Machine) -> boolean
