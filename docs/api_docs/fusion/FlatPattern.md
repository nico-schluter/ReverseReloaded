...
**Accessed from:** Component.createFlatPattern, Component.flatPattern, FlatPatternComponent.createFlatPattern, FlatPatternComponent.flatPattern, FlatPatternProduct.flatPattern
...
### getBendInfo(bendEdge: BRepEdge, isBendUp: boolean, bendAngle: double) -> boolean
...
- **Returns** (boolean): Returns true if the bend information was successfully returned.
...
### bendLinesBody : BRepBody [read-only]
...
### extentLinesBody : BRepBody [read-only]
