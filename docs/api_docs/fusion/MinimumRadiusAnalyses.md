...
**Accessed from:** Analyses.minimumRadiusAnalyses
...
### item(index: uinteger) -> MinimumRadiusAnalysis
...
- **Returns** (MinimumRadiusAnalysis): Returns the specified item or null if an invalid index was specified.

### itemByName(name: string) -> MinimumRadiusAnalysis
...
- **Returns** (MinimumRadiusAnalysis): Returns the specified item or null if an invalid name was specified.
