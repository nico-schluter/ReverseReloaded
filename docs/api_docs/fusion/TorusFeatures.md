...
**Accessed from:** Features.torusFeatures
...
### item(index: uinteger) -> TorusFeature
Function that returns the specified torus feature using an index into the collection.
- **index** (uinteger): The index of the item within the collection to return. The first item in the collection has an index of 0.
- **Returns** (TorusFeature): Returns the specified item or null if an invalid index was specified.

### itemByName(name: string) -> TorusFeature
Function that returns the specified torus feature using the name of the feature.
- **name** (string): The name of the feature within the collection to return. This is the name seen in the timeline.
- **Returns** (TorusFeature): Returns the specified item or null if the specified name was not found.
