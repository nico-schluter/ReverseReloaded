...
**Accessed from:** FaceGroup.createForAssemblyContext, FaceGroup.nativeObject, FaceGroups.item, MeshCombineFaceGroupsFeature.inputFaceGroups, MeshCombineFaceGroupsFeatureInput.inputFaceGroups
...
### createForAssemblyContext(occurrence: Occurrence) -> FaceGroup
...
- **Returns** (FaceGroup): Returns the new face group proxy or null if this isn't the NativeObject.
...
### nativeObject : FaceGroup [read-only]
