...
**Accessed from:** CustomFeatureDefinition.customFeatureCompute

## Methods

### add(handler: CustomFeatureEventHandler) -> boolean
Add a handler to be notified when the file event occurs.
- **handler** (CustomFeatureEventHandler): The handler object to be called when this event is fired.
...
- **handler** (CustomFeatureEventHandler): The handler object to be removed from the event.
