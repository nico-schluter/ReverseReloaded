...
**Accessed from:** ConfigurationColumns.addInsertColumn, ConfigurationInsertCell.parentColumn
...
### getCell(rowIndex: uinteger) -> ConfigurationInsertCell
...
- **Returns** (ConfigurationInsertCell): Returns the specified cell if successful and null if an invalid index was specified.

### getCellByRowId(rowId: string) -> ConfigurationInsertCell
Gets the cell in this column at the row specified by its ID.
- **rowId** (string): The ID of the row to return the cell for.
- **Returns** (ConfigurationInsertCell): Returns the specified cell if successful and null if the name is not found.

### getCellByRowName(rowName: string) -> ConfigurationInsertCell
