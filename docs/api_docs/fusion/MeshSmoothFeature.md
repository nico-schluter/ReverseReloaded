...
**Accessed from:** MeshSmoothFeature.createForAssemblyContext, MeshSmoothFeature.nativeObject, MeshSmoothFeatures.add, MeshSmoothFeatures.item, MeshSmoothFeatures.itemByName
...
### createForAssemblyContext(occurrence: Occurrence) -> MeshSmoothFeature
Creates or returns a proxy for the native object - i.e. a new object that represents this object but adds the assembly context defined by the input occurrence.
- **occurrence** (Occurrence): The occurrence that defines the context to create the proxy in.
- **Returns** (MeshSmoothFeature): Returns the proxy object or null if this isn't the NativeObject.
...
### nativeObject : MeshSmoothFeature [read-only]
...
### smoothness : ModelParameter [read-only]
