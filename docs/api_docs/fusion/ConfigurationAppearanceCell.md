...
**Accessed from:** ConfigurationAppearanceColumn.getCell, ConfigurationAppearanceColumn.getCellByRowId, ConfigurationAppearanceColumn.getCellByRowName
...
### parentColumn : ConfigurationAppearanceColumn [read-only]
