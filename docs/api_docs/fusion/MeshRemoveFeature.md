...
**Accessed from:** MeshRemoveFeature.createForAssemblyContext, MeshRemoveFeature.nativeObject, MeshRemoveFeatures.add, MeshRemoveFeatures.item, MeshRemoveFeatures.itemByName
...
### createForAssemblyContext(occurrence: Occurrence) -> MeshRemoveFeature
Creates or returns a proxy for the native object - i.e. a new object that represents this object but adds the assembly context defined by the input occurrence.
- **occurrence** (Occurrence): The occurrence that defines the context to create the proxy in.
- **Returns** (MeshRemoveFeature): Returns the proxy object or null if this isn't the NativeObject.
...
### nativeObject : MeshRemoveFeature [read-only]
