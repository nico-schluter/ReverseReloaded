...
**Accessed from:** CollinearConstraint.lineOne, CollinearConstraint.lineTwo, HorizontalConstraint.line, LineOnPlanarSurfaceConstraint.line, LineParallelToPlanarSurfaceConstraint.line, MultiLineTextDefinition.rectangleLines, ParallelConstraint.lineOne, ParallelConstraint.lineTwo, PerpendicularConstraint.lineOne, PerpendicularConstraint.lineTwo, PolygonConstraint.lines, RectangularPatternConstraint.directionOneEntity, RectangularPatternConstraint.directionTwoEntity, RectangularPatternConstraintInput.directionOneEntity, RectangularPatternConstraintInput.directionTwoEntity, SketchAngularDimension.lineOne, SketchAngularDimension.lineTwo, SketchControlPointSpline.controlFrameLines, SketchDistanceBetweenLineAndPlanarSurfaceDimension.line, SketchEllipse.majorAxisLine, SketchEllipse.minorAxisLine, SketchFittedSpline.activateTangentHandle, SketchFittedSpline.getTangentHandle, SketchLine.createForAssemblyContext, SketchLine.nativeObject, SketchLinearDiameterDimension.line, SketchLineList.item, SketchLines.addAngleChamfer, SketchLines.addByMidpoint, SketchLines.addByTwoPoints, SketchLines.addDistanceChamfer, SketchLines.item, SketchOffsetDimension.line, SymmetryConstraint.symmetryLine, VerticalConstraint.line
...
### createForAssemblyContext(occurrence: Occurrence) -> SketchLine
Creates or returns a proxy for the native object - i.e. a new object that represents this object but adds the assembly context defined by the input occurrence.
- **occurrence** (Occurrence): The occurrence that defines the context to create the proxy in.
- **Returns** (SketchLine): Returns the proxy object or null if this isn't the NativeObject.
...
### isCenterLine : boolean [read-write]
...
### nativeObject : SketchLine [read-only]
...
### worldGeometry : Line3D [read-only]
