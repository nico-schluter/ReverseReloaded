...
**Accessed from:** ConfigurationMaterialTable.columns

## Methods

### add(entity: Base) -> ConfigurationMaterialColumn
...
- **entity** (Base): The component or body whose material will be controlled by this column.
- **Returns** (ConfigurationMaterialColumn): Returns the newly created ConfigurationMaterialColumn object or null if it fails.

### [static] classType() -> string
Static function that all classes support that returns the type of the class as a string. The returned string matches the string returned by the objectType property. For example if you have a reference to an object and you want to check if it's a SketchLine you can use myObject.objectType == fusion.SketchLine.classType().
- **Returns** (string): Returns a string indicating the type of the object.

### item(index: uinteger) -> ConfigurationMaterialColumn
...
- **Returns** (ConfigurationMaterialColumn): Returns the specified column or null if an invalid index was specified.

### itemById(id: string) -> ConfigurationMaterialColumn
A method that returns the column with the specified ID.
- **id** (string): The id of the column to return.
- **Returns** (ConfigurationMaterialColumn): Returns the specified column or null if a column with the specified ID does not exist.
