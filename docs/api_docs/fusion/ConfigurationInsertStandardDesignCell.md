...
**Accessed from:** ConfigurationInsertStandardDesignColumn.getCell, ConfigurationInsertStandardDesignColumn.getCellByRowId, ConfigurationInsertStandardDesignColumn.getCellByRowName
...
### parentColumn : ConfigurationInsertStandardDesignColumn [read-only]
Returns the column this cell is in.

### parentRow : ConfigurationRow [read-only]
Returns the row this cell is in.

### replaceDesign : ConfigurationReplaceDesign [read-write]
