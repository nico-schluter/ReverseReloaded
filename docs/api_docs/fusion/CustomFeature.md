...
**Accessed from:** CustomFeature.createForAssemblyContext, CustomFeature.nativeObject, CustomFeatureDependency.parentCustomFeature, CustomFeatureEventArgs.customFeature, CustomFeatureParameter.parentCustomFeature, CustomFeatures.add, CustomFeatures.item, CustomFeatures.itemByName
...
### createForAssemblyContext(occurrence: Occurrence) -> CustomFeature
Creates or returns a proxy for the native object - i.e. a new object that represents this object but adds the assembly context defined by the input occurrence.
- **occurrence** (Occurrence): The occurrence that defines the context to create the proxy in.
- **Returns** (CustomFeature): Returns the proxy object or null if this is not the NativeObject.
...
### customNamedValues : CustomNamedValues [read-only]
...
### definition : CustomFeatureDefinition [read-only]
...
### dependencies : CustomFeatureDependencies [read-only]
...
### nativeObject : CustomFeature [read-only]
...
### parameters : CustomFeatureParameters [read-only]
