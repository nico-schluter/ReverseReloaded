...
**Accessed from:** UnstitchFeature.createForAssemblyContext, UnstitchFeature.nativeObject, UnstitchFeatures.add, UnstitchFeatures.item, UnstitchFeatures.itemByName
...
### createForAssemblyContext(occurrence: Occurrence) -> UnstitchFeature
Creates or returns a proxy for the native object - i.e. a new object that represents this object but adds the assembly context defined by the input occurrence.
- **occurrence** (Occurrence): The occurrence that defines the context to create the proxy in.
- **Returns** (UnstitchFeature): Returns the proxy object or null if this is not the NativeObject.
...
### setInputFaces(faces: ObjectCollection, isChainSelection: boolean) -> boolean
...
### inputFaces : ObjectCollection [read-only]
...
### nativeObject : UnstitchFeature [read-only]
