...
**Accessed from:** GeometricConstraints.addHorizontalPoints, HorizontalPointsConstraint.createForAssemblyContext, HorizontalPointsConstraint.nativeObject
...
### createForAssemblyContext(occurrence: Occurrence) -> HorizontalPointsConstraint
Creates or returns a proxy for the native object - i.e. a new object that represents this object but adds the assembly context defined by the input occurrence.
- **occurrence** (Occurrence): The occurrence that defines the context to create the proxy in.
- **Returns** (HorizontalPointsConstraint): Returns the proxy object or null if this isn't the NativeObject.
...
### nativeObject : HorizontalPointsConstraint [read-only]
...
### pointOne : SketchPoint [read-only]
Returns the first point.

### pointTwo : SketchPoint [read-only]
