...
**Accessed from:** VolumetricCustomFeature.createForAssemblyContext, VolumetricCustomFeature.nativeObject, VolumetricCustomFeatures.add, VolumetricCustomFeatures.item, VolumetricCustomFeatures.itemByName
...
### createForAssemblyContext(occurrence: Occurrence) -> VolumetricCustomFeature
Creates or returns a proxy for the native object - i.e. a new object that represents this object but adds the assembly context defined by the input occurrence.
- **occurrence** (Occurrence): The occurrence that defines the context to create the proxy in.
- **Returns** (VolumetricCustomFeature): Returns the proxy object or null if this isn't the NativeObject.
...
### nativeObject : VolumetricCustomFeature [read-only]
...
### volumetricModel : Base [read-only]
