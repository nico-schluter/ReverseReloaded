...
**Accessed from:** SketchConcentricCircleDimension.createForAssemblyContext, SketchConcentricCircleDimension.nativeObject, SketchDimensions.addConcentricCircleDimension
...
### createForAssemblyContext(occurrence: Occurrence) -> SketchConcentricCircleDimension
Creates or returns a proxy for the native object - i.e. a new object that represents this object but adds the assembly context defined by the input occurrence.
- **occurrence** (Occurrence): The occurrence that defines the context to create the proxy in.
- **Returns** (SketchConcentricCircleDimension): Returns the proxy object or null if this isn't the NativeObject.
...
### circleOne : SketchCurve [read-only]
Returns the first concentric circle or arc.

### circleTwo : SketchCurve [read-only]
...
### nativeObject : SketchConcentricCircleDimension [read-only]
