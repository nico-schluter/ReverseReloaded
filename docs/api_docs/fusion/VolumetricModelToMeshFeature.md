...
**Accessed from:** VolumetricModelToMeshFeature.createForAssemblyContext, VolumetricModelToMeshFeature.nativeObject, VolumetricModelToMeshFeatures.add, VolumetricModelToMeshFeatures.item, VolumetricModelToMeshFeatures.itemByName
...
### createForAssemblyContext(occurrence: Occurrence) -> VolumetricModelToMeshFeature
Creates or returns a proxy for the native object - i.e. a new object that represents this object but adds the assembly context defined by the input occurrence.
- **occurrence** (Occurrence): The occurrence that defines the context to create the proxy in.
- **Returns** (VolumetricModelToMeshFeature): Returns the proxy object or null if this isn't the NativeObject.
...
### elementSize : ModelParameter [read-only]
...
### nativeObject : VolumetricModelToMeshFeature [read-only]
...
### smallShellThreshold : ModelParameter [read-only]
