...
**Accessed from:** RipFeature.createForAssemblyContext, RipFeature.nativeObject, RipFeatures.add, RipFeatures.item, RipFeatures.itemByName
...
### createForAssemblyContext(occurrence: Occurrence) -> RipFeature
Creates or returns a proxy for the native object - i.e. a new object that represents this object but adds the assembly context defined by the input occurrence.
- **occurrence** (Occurrence): The occurrence that defines the context to create the proxy in.
- **Returns** (RipFeature): Returns the proxy object or null if this is not the NativeObject.
...
### redefineToAlongEdge(edge: BRepEdge, gapDistance: ValueInput) -> boolean
...
### redefineToBetweenPoints(pointOneEntity: Base, pointTwoEntity: Base, gapDistance: ValueInput, pointOneOffset: ValueInput, pointTwoOffset: ValueInput) -> boolean
...
### definition : RipFeatureDefinition [read-only]
...
### definitionType : RipFeatureDefinitionTypes [read-only]
...
### nativeObject : RipFeature [read-only]
