...
**Accessed from:** ConfigurationColumns.addSuppressColumn, ConfigurationSuppressCell.parentColumn
...
### getCell(rowIndex: uinteger) -> ConfigurationSuppressCell
...
- **Returns** (ConfigurationSuppressCell): Returns the specified cell if successful and null if an invalid index was specified.

### getCellByRowId(rowId: string) -> ConfigurationSuppressCell
Gets the cell in this column at the row specified by its ID.
- **rowId** (string): The ID of the row to return the cell for.
- **Returns** (ConfigurationSuppressCell): Returns the specified cell if successful and null if the name is not found.

### getCellByRowName(rowName: string) -> ConfigurationSuppressCell
