...
**Accessed from:** ReverseNormalFeature.createForAssemblyContext, ReverseNormalFeature.nativeObject, ReverseNormalFeatures.add, ReverseNormalFeatures.item, ReverseNormalFeatures.itemByName
...
### createForAssemblyContext(occurrence: Occurrence) -> ReverseNormalFeature
Creates or returns a proxy for the native object - i.e. a new object that represents this object but adds the assembly context defined by the input occurrence.
- **occurrence** (Occurrence): The occurrence that defines the context to create the proxy in.
- **Returns** (ReverseNormalFeature): Returns the proxy object or null if this is not the NativeObject.
...
### nativeObject : ReverseNormalFeature [read-only]
...
### surfaces : ObjectCollection [read-write]
