...
**Accessed from:** ConfigurationPropertyColumn.getCell, ConfigurationPropertyColumn.getCellByRowId, ConfigurationPropertyColumn.getCellByRowName
...
### parentColumn : ConfigurationPropertyColumn [read-only]
