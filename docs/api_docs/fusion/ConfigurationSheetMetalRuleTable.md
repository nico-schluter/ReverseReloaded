...
**Accessed from:** ConfigurationSheetMetalRuleColumn.parentSheetMetalRuleTable, ConfigurationTopTable.sheetMetalRuleTable
...
### columns : ConfigurationSheetMetalRuleColumns [read-only]
