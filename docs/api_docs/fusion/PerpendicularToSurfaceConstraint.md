...
**Accessed from:** GeometricConstraints.addPerpendicularToSurface, PerpendicularToSurfaceConstraint.createForAssemblyContext, PerpendicularToSurfaceConstraint.nativeObject
...
### createForAssemblyContext(occurrence: Occurrence) -> PerpendicularToSurfaceConstraint
Creates or returns a proxy for the native object - i.e. a new object that represents this object but adds the assembly context defined by the input occurrence.
- **occurrence** (Occurrence): The occurrence that defines the context to create the proxy in.
- **Returns** (PerpendicularToSurfaceConstraint): Returns the proxy object or null if this isn't the NativeObject.
...
### nativeObject : PerpendicularToSurfaceConstraint [read-only]
