...
**Accessed from:** ConfigurationThemeColumn.getCell, ConfigurationThemeColumn.getCellByRowId, ConfigurationThemeColumn.getCellByRowName
...
### parentColumn : ConfigurationThemeColumn [read-only]
Returns the column this cell is in.

### parentRow : ConfigurationRow [read-only]
Returns the row this cell is in.

### referencedTableRow : ConfigurationRow [read-write]
