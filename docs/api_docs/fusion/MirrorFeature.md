...
**Accessed from:** MirrorFeature.createForAssemblyContext, MirrorFeature.nativeObject, MirrorFeatures.add, MirrorFeatures.item, MirrorFeatures.itemByName
...
### createForAssemblyContext(occurrence: Occurrence) -> MirrorFeature
Creates or returns a proxy for the native object - i.e. a new object that represents this object but adds the assembly context defined by the input occurrence.
- **occurrence** (Occurrence): The occurrence that defines the context to create the proxy in.
- **Returns** (MirrorFeature): Returns the proxy object or null if this isn't the NativeObject.
...
### nativeObject : MirrorFeature [read-only]
...
### stitchTolerance : ModelParameter [read-only]
