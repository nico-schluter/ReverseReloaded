...
**Accessed from:** CornerClosureFeature.createForAssemblyContext, CornerClosureFeature.nativeObject, CornerClosureFeatures.add, CornerClosureFeatures.item, CornerClosureFeatures.itemByName
...
### createForAssemblyContext(occurrence: Occurrence) -> CornerClosureFeature
Creates or returns a proxy for the native object - i.e. a new object that represents this object but adds the assembly context defined by the input occurrence.
- **occurrence** (Occurrence): The occurrence that defines the context to create the proxy in.
- **Returns** (CornerClosureFeature): Returns the proxy object or null if this is not the NativeObject.
...
### definition : CornerClosureFeatureDefinition [read-only]
Returns the CornerClosureFeatureDefinition object which provides access to the information defining this CornerClosureFeature and the ability to edit it.
...
### nativeObject : CornerClosureFeature [read-only]
