...
**Accessed from:** SketchDimensions.addTangentDistanceDimension, SketchTangentDistanceDimension.createForAssemblyContext, SketchTangentDistanceDimension.nativeObject
...
### createForAssemblyContext(occurrence: Occurrence) -> SketchTangentDistanceDimension
Creates or returns a proxy for the native object - i.e. a new object that represents this object but adds the assembly context defined by the input occurrence.
- **occurrence** (Occurrence): The occurrence that defines the context to create the proxy in.
- **Returns** (SketchTangentDistanceDimension): Returns the proxy object or null if this isn't the NativeObject.
...
### circleOrArc : SketchCurve [read-only]
...
### nativeObject : SketchTangentDistanceDimension [read-only]
