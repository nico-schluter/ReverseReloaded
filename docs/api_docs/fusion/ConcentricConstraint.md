...
**Accessed from:** ConcentricConstraint.createForAssemblyContext, ConcentricConstraint.nativeObject, GeometricConstraints.addConcentric
...
### createForAssemblyContext(occurrence: Occurrence) -> ConcentricConstraint
Creates or returns a proxy for the native object - i.e. a new object that represents this object but adds the assembly context defined by the input occurrence.
- **occurrence** (Occurrence): The occurrence that defines the context to create the proxy in.
- **Returns** (ConcentricConstraint): Returns the proxy object or null if this isn't the NativeObject.
...
### entityOne : SketchCurve [read-only]
...
### entityTwo : SketchCurve [read-only]
...
### nativeObject : ConcentricConstraint [read-only]
