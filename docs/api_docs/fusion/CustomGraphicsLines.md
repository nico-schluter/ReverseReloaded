...
**Accessed from:** CustomGraphicsGroup.addLines
...
### isLineStrip : boolean [read-write]
...
### isScreenSpaceLineStyle : boolean [read-write]
...
### lineStripLengths : array [read-write]
...
### lineStylePattern : LineStylePatterns [read-write]
The line style to apply to the line. The default is to draw a continuous line.

### lineStyleScale : double [read-write]
