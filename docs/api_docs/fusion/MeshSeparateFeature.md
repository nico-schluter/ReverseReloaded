...
**Accessed from:** MeshSeparateFeature.createForAssemblyContext, MeshSeparateFeature.nativeObject, MeshSeparateFeatures.add, MeshSeparateFeatures.item, MeshSeparateFeatures.itemByName
...
### createForAssemblyContext(occurrence: Occurrence) -> MeshSeparateFeature
Creates or returns a proxy for the native object - i.e. a new object that represents this object but adds the assembly context defined by the input occurrence.
- **occurrence** (Occurrence): The occurrence that defines the context to create the proxy in.
- **Returns** (MeshSeparateFeature): Returns the proxy object or null if this isn't the NativeObject.
...
### isKeepBody : boolean [read-write]
Preserves a copy of the original mesh body.

### isMultipleBodies : boolean [read-write]
...
### meshSeparateType : MeshSeparateTypes [read-write]
Gets and sets the output type of mesh separation.

### name : string [read-write]
Returns the name of the feature as seen in the browser (non-parametric) or in the timeline (parametric).

### nativeObject : MeshSeparateFeature [read-only]
