...
**Accessed from:** Component.allTangentRelationships, FlatPatternComponent.allTangentRelationships, TangentRelationship.createForAssemblyContext, TangentRelationship.nativeObject, TangentRelationships.add, TangentRelationships.item, TangentRelationships.itemByName
...
### createForAssemblyContext(occurrence: Occurrence) -> TangentRelationship
Creates or returns a proxy for the native object - i.e. a new object that represents this object but adds the assembly context defined by the input occurrence.
- **occurrence** (Occurrence): The occurrence that defines the context to create the proxy in.
- **Returns** (TangentRelationship): Returns the proxy object or null if this isn't the NativeObject.
...
### nativeObject : TangentRelationship [read-only]
