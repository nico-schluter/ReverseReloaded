...
**Accessed from:** BaseComponent.constructionPoints, Component.constructionPoints, FlatPatternComponent.constructionPoints
...
- **Returns** (ConstructionPoint): Returns the newly created construction point or null if the creation failed.

### [static] classType() -> string
Static function that all classes support that returns the type of the class as a string. The returned string matches the string returned by the objectType property. For example if you have a reference to an object and you want to check if it's a SketchLine you can use myObject.objectType == fusion.SketchLine.classType().
- **Returns** (string): Returns a string indicating the type of the object.

### createInput(occurrenceForCreation: Occurrence) -> ConstructionPointInput
Create a ConstructionPointInput object that is in turn used to create a ConstructionPoint.
- **occurrenceForCreation** (Occurrence): A creation occurrence is needed if the input is in another component AND the construction point is not in the root component. The occurrenceForCreation is analogous to the active occurrence in the UI.

This is an optional argument whose default value is null.
- **Returns** (ConstructionPointInput): Returns a ConstructionPointInput object

### item(index: uinteger) -> ConstructionPoint
Function that returns the specified construction point using an index into the collection.
- **index** (uinteger): The index of the item within the collection to return. The first item in the collection has an index of 0.
- **Returns** (ConstructionPoint): Returns the specified item or null if an invalid index was specified.

### itemByName(name: string) -> ConstructionPoint
...
- **Returns** (ConstructionPoint): Returns the specified item or null if an invalid name was specified.
