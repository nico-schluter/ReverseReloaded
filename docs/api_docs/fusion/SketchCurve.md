...
**Accessed from:** ConcentricConstraint.entityOne, ConcentricConstraint.entityTwo, EqualConstraint.curveOne, EqualConstraint.curveTwo, MidPointConstraint.midPointCurve, OffsetConstraint.childCurves, OffsetConstraint.parentCurves, OffsetConstraintInput.curves, PerpendicularToSurfaceConstraint.curve, SharedPointCoincident.curveOne, SharedPointCoincident.curveTwo, SketchConcentricCircleDimension.circleOne, SketchConcentricCircleDimension.circleTwo, SketchCurves.item, SketchDiameterDimension.entity, SketchEllipseMajorRadiusDimension.ellipse, SketchEllipseMinorRadiusDimension.ellipse, SketchRadialDimension.entity, SketchTangentDistanceDimension.circleOrArc, SketchText.explode, SmoothConstraint.curveOne, SmoothConstraint.curveTwo, TangentConstraint.curveOne, TangentConstraint.curveTwo
