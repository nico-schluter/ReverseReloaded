...
**Accessed from:** Profile.profileLoops
...
### item(index: uinteger) -> ProfileLoop
Function that returns the specified profile loop using an index into the collection.
- **index** (uinteger): The index of the item within the collection to return. The first item in the collection has an index of 0.
- **Returns** (ProfileLoop): Returns the specified item or null if an invalid index was specified.
