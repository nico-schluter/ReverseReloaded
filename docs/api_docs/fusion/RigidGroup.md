...
**Accessed from:** Component.allRigidGroups, FlatPatternComponent.allRigidGroups, RigidGroup.createForAssemblyContext, RigidGroup.nativeObject, RigidGroupList.item, RigidGroupList.itemByName, RigidGroups.add, RigidGroups.item, RigidGroups.itemByName
...
### createForAssemblyContext(occurrence: Occurrence) -> RigidGroup
Creates or returns a proxy for the native object - i.e. a new object that represents this object but adds the assembly context defined by the input occurrence.
- **occurrence** (Occurrence): The occurrence that defines the context to create the proxy in.
- **Returns** (RigidGroup): Returns the proxy object or null if this isn't the NativeObject.

### deleteMe() -> boolean
Deletes this rigid group.
- **Returns** (boolean): Returns True if the delete was successful.

### setOccurrences(occurrences: ObjectCollection, includeChildren: boolean) -> boolean
...
### nativeObject : RigidGroup [read-only]
...
### occurrences : OccurrenceList [read-only]
