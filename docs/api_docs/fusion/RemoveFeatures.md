...
**Accessed from:** Features.removeFeatures

## Methods

### add(itemToRemove: Base) -> RemoveFeature
Creates a new Remove feature.
- **itemToRemove** (Base): A single body (solid or surface) or component occurrence to remove.
- **Returns** (RemoveFeature): Returns the newly created RemoveFeature object or null if the creation failed.

### [static] classType() -> string
Static function that all classes support that returns the type of the class as a string. The returned string matches the string returned by the objectType property. For example if you have a reference to an object and you want to check if it's a SketchLine you can use myObject.objectType == fusion.SketchLine.classType().
- **Returns** (string): Returns a string indicating the type of the object.

### item(index: uinteger) -> RemoveFeature
Function that returns the specified Remove feature using an index into the collection.
- **index** (uinteger): The index of the item within the collection to return. The first item in the collection has an index of 0.
- **Returns** (RemoveFeature): Returns the specified item or null if an invalid index was specified.

### itemByName(name: string) -> RemoveFeature
Function that returns the specified remove feature using the name of the feature.
- **name** (string): The name of the feature within the collection to return. This is the name seen in the timeline.
- **Returns** (RemoveFeature): Returns the specified item or null if the specified name was not found.
