...
**Accessed from:** EqualConstraint.createForAssemblyContext, EqualConstraint.nativeObject, GeometricConstraints.addEqual
...
### createForAssemblyContext(occurrence: Occurrence) -> EqualConstraint
Creates or returns a proxy for the native object - i.e. a new object that represents this object but adds the assembly context defined by the input occurrence.
- **occurrence** (Occurrence): The occurrence that defines the context to create the proxy in.
- **Returns** (EqualConstraint): Returns the proxy object or null if this isn't the NativeObject.
...
### nativeObject : EqualConstraint [read-only]
