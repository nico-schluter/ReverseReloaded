...
**Accessed from:** DraftFeature.createForAssemblyContext, DraftFeature.nativeObject, DraftFeatures.add, DraftFeatures.item, DraftFeatures.itemByName
...
### createForAssemblyContext(occurrence: Occurrence) -> DraftFeature
Creates or returns a proxy for the native object - i.e. a new object that represents this object but adds the assembly context defined by the input occurrence.
- **occurrence** (Occurrence): The occurrence that defines the context to create the proxy in.
- **Returns** (DraftFeature): Returns the proxy object or null if this isn't the NativeObject.
...
### draftDefinition : ExtentDefinition [read-only]
...
### nativeObject : DraftFeature [read-only]
