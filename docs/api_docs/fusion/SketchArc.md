...
**Accessed from:** SketchArc.createForAssemblyContext, SketchArc.nativeObject, SketchArcs.addByCenterStartEnd, SketchArcs.addByCenterStartSweep, SketchArcs.addByThreePoints, SketchArcs.addFillet, SketchArcs.item, SketchFittedSpline.activateCurvatureHandle, SketchFittedSpline.getCurvatureHandle
...
### createForAssemblyContext(occurrence: Occurrence) -> SketchArc
Creates or returns a proxy for the native object - i.e. a new object that represents this object but adds the assembly context defined by the input occurrence.
- **occurrence** (Occurrence): The occurrence that defines the context to create the proxy in.
- **Returns** (SketchArc): Returns the proxy object or null if this isn't the NativeObject.
...
### nativeObject : SketchArc [read-only]
