...
**Accessed from:** CustomGraphicsGroup.addText
...
### isItalic : boolean [read-write]
Specifies that the text displays using an italic style. This is the default italic style and applies to all of text unless there is a style override defined within the text.
...
### isStrikeThrough : boolean [read-write]
...
### isUnderline : boolean [read-write]
Specifies that the text displays using an underline style. This is the default underline style and applies to all of text unless there is a style override defined within the text.
