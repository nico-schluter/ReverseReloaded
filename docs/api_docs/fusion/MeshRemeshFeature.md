...
**Accessed from:** MeshRemeshFeature.createForAssemblyContext, MeshRemeshFeature.nativeObject, MeshRemeshFeatures.add, MeshRemeshFeatures.item, MeshRemeshFeatures.itemByName
...
### createForAssemblyContext(occurrence: Occurrence) -> MeshRemeshFeature
Creates or returns a proxy for the native object - i.e. a new object that represents this object but adds the assembly context defined by the input occurrence.
- **occurrence** (Occurrence): The occurrence that defines the context to create the proxy in.
- **Returns** (MeshRemeshFeature): Returns the proxy object or null if this isn't the NativeObject.
...
### density : ModelParameter [read-only]
...
### isPreserveBoundariesEnabled : boolean [read-write]
Gets and sets if open boundary edges are preserved during the re-mesh process.

### isPreserveSharpEdgesEnabled : boolean [read-write]
...
### meshRemeshMethodType : MeshRemeshMethodTypes [read-write]
Gets and sets the type of mesh re-mesh.

### name : string [read-write]
Returns the name of the feature as seen in the browser (non-parametric) or in the timeline (parametric).

### nativeObject : MeshRemeshFeature [read-only]
...
### shapePreservation : ModelParameter [read-only]
