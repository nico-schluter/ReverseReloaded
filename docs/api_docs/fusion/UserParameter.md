...
**Accessed from:** UserParameters.add, UserParameters.asArray, UserParameters.item, UserParameters.itemByName
...
- **Returns** (boolean): Returns a bool indicating if the delete was successful or not. Bug!!! Currently returning true if the parameter can't be deleted because it is being referenced by other parameters.
