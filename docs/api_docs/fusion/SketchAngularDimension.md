...
**Accessed from:** SketchAngularDimension.createForAssemblyContext, SketchAngularDimension.nativeObject, SketchDimensions.addAngularDimension
...
### createForAssemblyContext(occurrence: Occurrence) -> SketchAngularDimension
Creates or returns a proxy for the native object - i.e. a new object that represents this object but adds the assembly context defined by the input occurrence.
- **occurrence** (Occurrence): The occurrence that defines the context to create the proxy in.
- **Returns** (SketchAngularDimension): Returns the proxy object or null if this isn't the NativeObject.
...
### lineOne : SketchLine [read-only]
The first line being constrained.

### lineTwo : SketchLine [read-only]
The second line being constrained.

### nativeObject : SketchAngularDimension [read-only]
