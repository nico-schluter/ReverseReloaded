...
**Accessed from:** ConfigurationInsertColumn.getCell, ConfigurationInsertColumn.getCellByRowId, ConfigurationInsertColumn.getCellByRowName
...
### parentColumn : ConfigurationInsertColumn [read-only]
Returns the column this cell is in.

### parentRow : ConfigurationRow [read-only]
Returns the row this cell is in.

### row : ConfigurationRow [read-write]
