...
**Accessed from:** SketchConicCurve.createForAssemblyContext, SketchConicCurve.nativeObject, SketchConicCurves.add, SketchConicCurves.item
...
### createForAssemblyContext(occurrence: Occurrence) -> SketchConicCurve
Creates or returns a proxy for the native object - i.e. a new object that represents this object but adds the assembly context defined by the input occurrence.
- **occurrence** (Occurrence): The occurrence that defines the context to create the proxy in.
- **Returns** (SketchConicCurve): Returns the proxy object or null if this isn't the NativeObject.
...
### apexSketchPoint : SketchPoint [read-only]
...
### nativeObject : SketchConicCurve [read-only]
