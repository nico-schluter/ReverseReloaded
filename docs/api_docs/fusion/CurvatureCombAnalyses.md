...
**Accessed from:** Analyses.curvatureCombAnalyses
...
### item(index: uinteger) -> CurvatureCombAnalysis
...
- **Returns** (CurvatureCombAnalysis): Returns the specified item or null if an invalid index was specified.

### itemByName(name: string) -> CurvatureCombAnalysis
...
- **Returns** (CurvatureCombAnalysis): Returns the specified item or null if an invalid name was specified.
