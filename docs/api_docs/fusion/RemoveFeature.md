...
**Accessed from:** RemoveFeature.createForAssemblyContext, RemoveFeature.nativeObject, RemoveFeatures.add, RemoveFeatures.item, RemoveFeatures.itemByName
...
### createForAssemblyContext(occurrence: Occurrence) -> RemoveFeature
Creates or returns a proxy for the native object - i.e. a new object that represents this object but adds the assembly context defined by the input occurrence.
- **occurrence** (Occurrence): The occurrence that defines the context to create the proxy in.
- **Returns** (RemoveFeature): Returns the proxy object or null if this is not the NativeObject.
...
### nativeObject : RemoveFeature [read-only]
