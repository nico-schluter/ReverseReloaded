...
Inherits: FlangeFeature
Since: September 2025

Defines a hem feature, providing methods to redefine the type of hem.

**Accessed from:** HemFeature.createForAssemblyContext, HemFeature.nativeObject, HemFeatures.add, HemFeatures.item, HemFeatures.itemByName
...
### createForAssemblyContext(occurrence: Occurrence) -> HemFeature
Creates or returns a proxy for the native object - i.e. a new object that represents this object but adds the assembly context defined by the input occurrence.
- **occurrence** (Occurrence): The occurrence that defines the context to create the proxy in.
- **Returns** (HemFeature): Returns the proxy object or null if this is not the NativeObject.
...
### redefineAsDoubleHem(gap: ValueInput, length: ValueInput, setback: ValueInput, isFlipped: boolean, bendPositionType: BendPositionTypes) -> boolean
...
### redefineAsFlatHem(length: ValueInput, isFlipped: boolean, bendPositionType: BendPositionTypes) -> boolean
...
### redefineAsOpenHem(length: ValueInput, gap: ValueInput, isFlipped: boolean, bendPositionType: BendPositionTypes) -> boolean
...
### redefineAsRolledHem(radius: ValueInput, angle: ValueInput, isFlipped: boolean, bendPositionType: BendPositionTypes) -> boolean
...
### redefineAsRopeHem(length: ValueInput, gap: ValueInput, radius: ValueInput, isFlipped: boolean, bendPositionType: BendPositionTypes) -> boolean
...
### redefineAsTeardropHem(radius: ValueInput, length: ValueInput, gap: ValueInput, isFlipped: boolean, bendPositionType: BendPositionTypes) -> boolean
Redefines the hem as a teardrop hem.
- **radius** (ValueInput): The radius of the teardrop hem.
- **length** (ValueInput): The length of the teardrop hem.
- **gap** (ValueInput): The gap distance of the hem.
- **isFlipped** (boolean): Indicates if the hem direction is flipped.
- **bendPositionType** (BendPositionTypes): The bend location type for the hem.
- **Returns** (boolean): Returns true if defining the hem is successful.
...
### definition : HemFeatureDefinition [read-only]
...
### definitionType : HemFeatureDefinitionTypes [read-only]
...
### nativeObject : HemFeature [read-only]
