...
**Accessed from:** ConfigurationMaterialColumn.parentMaterialTable, ConfigurationTopTable.materialTable
...
### clear() -> boolean
Clears the content of the material table, removes the reference from the top table, and hides it in the user interface.
...
### columns : ConfigurationMaterialColumns [read-only]
