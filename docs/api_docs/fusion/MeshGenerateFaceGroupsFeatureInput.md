...
**Accessed from:** MeshGenerateFaceGroupsFeatures.createInput
...
### angleThreshold : ValueInput [read-write]
...
### boundaryTolerance : ValueInput [read-write]
...
### minimumFaceGroupSize : ValueInput [read-write]
