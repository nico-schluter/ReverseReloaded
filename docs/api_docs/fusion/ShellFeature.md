...
**Accessed from:** ShellFeature.createForAssemblyContext, ShellFeature.nativeObject, ShellFeatures.add, ShellFeatures.item, ShellFeatures.itemByName
...
### createForAssemblyContext(occurrence: Occurrence) -> ShellFeature
Creates or returns a proxy for the native object - i.e. a new object that represents this object but adds the assembly context defined by the input occurrence.
- **occurrence** (Occurrence): The occurrence that defines the context to create the proxy in.
- **Returns** (ShellFeature): Returns the proxy object or null if this isn't the NativeObject.
...
### setInputEntities(inputEntities: ObjectCollection, isTangentChain: boolean) -> boolean
...
### setThicknesses(insideThickness: ValueInput, outsideThickness: ValueInput) -> boolean
...
### inputEntities : ObjectCollection [read-only]
Gets the input faces/bodies.

### insideThickness : ModelParameter [read-only]
...
### isTangentChain : boolean [read-only]
...
### nativeObject : ShellFeature [read-only]
...
### outsideThickness : ModelParameter [read-only]
