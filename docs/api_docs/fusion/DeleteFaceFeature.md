...
**Accessed from:** DeleteFaceFeature.createForAssemblyContext, DeleteFaceFeature.nativeObject, DeleteFaceFeatures.add, DeleteFaceFeatures.item, DeleteFaceFeatures.itemByName
...
### createForAssemblyContext(occurrence: Occurrence) -> DeleteFaceFeature
Creates or returns a proxy for the native object - i.e. a new object that represents this object but adds the assembly context defined by the input occurrence.
- **occurrence** (Occurrence): The occurrence that defines the context to create the proxy in.
- **Returns** (DeleteFaceFeature): Returns the proxy object or null if this is not the NativeObject.
...
### nativeObject : DeleteFaceFeature [read-only]
