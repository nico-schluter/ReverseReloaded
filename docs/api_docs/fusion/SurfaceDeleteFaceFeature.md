...
**Accessed from:** SurfaceDeleteFaceFeature.createForAssemblyContext, SurfaceDeleteFaceFeature.nativeObject, SurfaceDeleteFaceFeatures.add, SurfaceDeleteFaceFeatures.item, SurfaceDeleteFaceFeatures.itemByName
...
### createForAssemblyContext(occurrence: Occurrence) -> SurfaceDeleteFaceFeature
Creates or returns a proxy for the native object - i.e. a new object that represents this object but adds the assembly context defined by the input occurrence.
- **occurrence** (Occurrence): The occurrence that defines the context to create the proxy in.
- **Returns** (SurfaceDeleteFaceFeature): Returns the proxy object or null if this is not the NativeObject.
...
### nativeObject : SurfaceDeleteFaceFeature [read-only]
