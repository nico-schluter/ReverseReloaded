...
**Accessed from:** SketchEllipticalArc.createForAssemblyContext, SketchEllipticalArc.nativeObject, SketchEllipticalArcs.addByAngle, SketchEllipticalArcs.addByEndPoints, SketchEllipticalArcs.item
...
### createForAssemblyContext(occurrence: Occurrence) -> SketchEllipticalArc
Creates or returns a proxy for the native object - i.e. a new object that represents this object but adds the assembly context defined by the input occurrence.
- **occurrence** (Occurrence): The occurrence that defines the context to create the proxy in.
- **Returns** (SketchEllipticalArc): Returns the proxy object or null if this isn't the NativeObject.
...
### geometry : EllipticalArc3D [read-only]
...
### majorAxisRadius : double [read-write]
...
### minorAxisRadius : double [read-write]
...
### nativeObject : SketchEllipticalArc [read-only]
...
### worldGeometry : EllipticalArc3D [read-only]
