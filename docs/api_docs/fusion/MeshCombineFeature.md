...
**Accessed from:** MeshCombineFeature.createForAssemblyContext, MeshCombineFeature.nativeObject, MeshCombineFeatures.add, MeshCombineFeatures.item, MeshCombineFeatures.itemByName
...
### createForAssemblyContext(occurrence: Occurrence) -> MeshCombineFeature
Creates or returns a proxy for the native object - i.e. a new object that represents this object but adds the assembly context defined by the input occurrence.
- **occurrence** (Occurrence): The occurrence that defines the context to create the proxy in.
- **Returns** (MeshCombineFeature): Returns the proxy object or null if this isn't the NativeObject.
...
### isNewComponent : boolean [read-only]
...
### meshCombineOperationType : MeshCombineOperationTypes [read-write]
Gets and sets the operation type of mesh combine.

### name : string [read-write]
Returns the name of the feature as seen in the browser (non-parametric) or in the timeline (parametric).

### nativeObject : MeshCombineFeature [read-only]
