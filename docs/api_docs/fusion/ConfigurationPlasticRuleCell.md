...
**Accessed from:** ConfigurationPlasticRuleColumn.getCell, ConfigurationPlasticRuleColumn.getCellByRowId, ConfigurationPlasticRuleColumn.getCellByRowName
...
### parentColumn : ConfigurationPlasticRuleColumn [read-only]
Returns the column this cell is in.

### parentRow : ConfigurationRow [read-only]
Returns the row this cell is in.

### plasticRule : PlasticRule [read-write]
