...
**Accessed from:** ReplaceFaceFeature.createForAssemblyContext, ReplaceFaceFeature.nativeObject, ReplaceFaceFeatures.add, ReplaceFaceFeatures.item, ReplaceFaceFeatures.itemByName
...
### createForAssemblyContext(occurrence: Occurrence) -> ReplaceFaceFeature
Creates or returns a proxy for the native object - i.e. a new object that represents this object but adds the assembly context defined by the input occurrence.
- **occurrence** (Occurrence): The occurrence that defines the context to create the proxy in.
- **Returns** (ReplaceFaceFeature): Returns the proxy object or null if this isn't the NativeObject.
...
### setInputEntities(sourceFaces: ObjectCollection, isTangentChain: boolean) -> boolean
...
### nativeObject : ReplaceFaceFeature [read-only]
