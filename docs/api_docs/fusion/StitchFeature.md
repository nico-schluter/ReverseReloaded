...
**Accessed from:** StitchFeature.createForAssemblyContext, StitchFeature.nativeObject, StitchFeatures.add, StitchFeatures.item, StitchFeatures.itemByName
...
### createForAssemblyContext(occurrence: Occurrence) -> StitchFeature
Creates or returns a proxy for the native object - i.e. a new object that represents this object but adds the assembly context defined by the input occurrence.
- **occurrence** (Occurrence): The occurrence that defines the context to create the proxy in.
- **Returns** (StitchFeature): Returns the proxy object or null if this is not the NativeObject.
...
### nativeObject : StitchFeature [read-only]
...
### stitchSurfaces : ObjectCollection [read-write]
...
### tolerance : ModelParameter [read-only]
