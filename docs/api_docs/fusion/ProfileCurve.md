...
**Accessed from:** ProfileCurve.createForAssemblyContext, ProfileCurve.nativeObject, ProfileCurves.item
...
### createForAssemblyContext(occurrence: Occurrence) -> ProfileCurve
...
- **Returns** (ProfileCurve): Returns the proxy object or null if this isn't the NativeObject.
...
### parentProfileLoop : ProfileLoop [read-only]
Returns the parent ProfileLoop object.

### parentSketch : Sketch [read-only]
Returns the parent Profile object.

### sketchEntity : SketchEntity [read-only]
