...
**Accessed from:** BoundaryFillFeature.bRepCells, BoundaryFillFeatureInput.bRepCells, TrimFeature.bRepCells, TrimFeatureInput.bRepCells
...
### item(index: uinteger) -> BRepCell
Function that returns the specified BRepCell using an index into the collection.
- **index** (uinteger): The index of the item within the collection to return. The first item in the collection has an index of 0.
- **Returns** (BRepCell): Returns the specified item or null if an invalid index was specified.
