...
**Accessed from:** CollinearConstraint.createForAssemblyContext, CollinearConstraint.nativeObject, GeometricConstraints.addCollinear
...
### createForAssemblyContext(occurrence: Occurrence) -> CollinearConstraint
Creates or returns a proxy for the native object - i.e. a new object that represents this object but adds the assembly context defined by the input occurrence.
- **occurrence** (Occurrence): The occurrence that defines the context to create the proxy in.
- **Returns** (CollinearConstraint): Returns the proxy object or null if this isn't the NativeObject.
...
### nativeObject : CollinearConstraint [read-only]
