# ConfigurationPlasticRuleColumn
...
**Accessed from:** ConfigurationPlasticRuleCell.parentColumn, ConfigurationPlasticRuleColumns.add, ConfigurationPlasticRuleColumns.item, ConfigurationPlasticRuleColumns.itemById
...
### getCell(rowIndex: uinteger) -> ConfigurationPlasticRuleCell
...
- **Returns** (ConfigurationPlasticRuleCell): Returns the specified cell if successful and null if an invalid index was specified.

### getCellByRowId(rowId: string) -> ConfigurationPlasticRuleCell
Gets the cell in this column at the row specified by its ID.
- **rowId** (string): The ID of the row to return the cell for.
- **Returns** (ConfigurationPlasticRuleCell): Returns the specified cell if successful and null if the id is not found.

### getCellByRowName(rowName: string) -> ConfigurationPlasticRuleCell
Gets the cell in this column at the row specified by its name.
- **rowName** (string): The name of the row to return the cell for.
- **Returns** (ConfigurationPlasticRuleCell): Returns the specified cell if successful and null if the name is not found.
...
### parentPlasticRuleTable : ConfigurationPlasticRuleTable [read-only]
