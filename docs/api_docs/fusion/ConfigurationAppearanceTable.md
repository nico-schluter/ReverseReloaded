...
**Accessed from:** ConfigurationAppearanceColumn.parentAppearanceTable, ConfigurationTopTable.appearanceTable
...
### columns : ConfigurationAppearanceColumns [read-only]
