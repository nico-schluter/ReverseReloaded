...
**Accessed from:** MeshRepairFeature.createForAssemblyContext, MeshRepairFeature.nativeObject, MeshRepairFeatures.add, MeshRepairFeatures.item, MeshRepairFeatures.itemByName
...
### createForAssemblyContext(occurrence: Occurrence) -> MeshRepairFeature
Creates or returns a proxy for the native object - i.e. a new object that represents this object but adds the assembly context defined by the input occurrence.
- **occurrence** (Occurrence): The occurrence that defines the context to create the proxy in.
- **Returns** (MeshRepairFeature): Returns the proxy object or null if this isn't the NativeObject.
...
### nativeObject : MeshRepairFeature [read-only]
