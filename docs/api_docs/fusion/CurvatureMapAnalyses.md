...
**Accessed from:** Analyses.curvatureMapAnalyses
...
### item(index: uinteger) -> CurvatureMapAnalysis
...
- **Returns** (CurvatureMapAnalysis): Returns the specified item or null if an invalid index was specified.

### itemByName(name: string) -> CurvatureMapAnalysis
...
- **Returns** (CurvatureMapAnalysis): Returns the specified item or null if an invalid name was specified.
