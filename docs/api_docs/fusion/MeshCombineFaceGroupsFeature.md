...
**Accessed from:** MeshCombineFaceGroupsFeature.createForAssemblyContext, MeshCombineFaceGroupsFeature.nativeObject, MeshCombineFaceGroupsFeatures.add, MeshCombineFaceGroupsFeatures.item, MeshCombineFaceGroupsFeatures.itemByName
...
### createForAssemblyContext(occurrence: Occurrence) -> MeshCombineFaceGroupsFeature
Creates or returns a proxy for the native object - i.e. a new object that represents this object but adds the assembly context defined by the input occurrence.
- **occurrence** (Occurrence): The occurrence that defines the context to create the proxy in.
- **Returns** (MeshCombineFaceGroupsFeature): Returns the proxy object or null if this isn't the NativeObject.
...
### inputFaceGroups : array [read-write]
...
### nativeObject : MeshCombineFaceGroupsFeature [read-only]
