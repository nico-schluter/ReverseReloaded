...
**Accessed from:** PathPatternFeature.createForAssemblyContext, PathPatternFeature.nativeObject, PathPatternFeatures.add, PathPatternFeatures.item, PathPatternFeatures.itemByName
...
### createForAssemblyContext(occurrence: Occurrence) -> PathPatternFeature
Creates or returns a proxy for the native object - i.e. a new object that represents this object but adds the assembly context defined by the input occurrence.
- **occurrence** (Occurrence): The occurrence that defines the context to create the proxy in.
- **Returns** (PathPatternFeature): Returns the proxy object or null if this isn't the NativeObject.
...
### nativeObject : PathPatternFeature [read-only]
