# ConfigurationInsertStandardDesignColumn
...
**Accessed from:** ConfigurationColumns.addInsertStandardDesignColumn, ConfigurationInsertStandardDesignCell.parentColumn
...
### getCell(rowIndex: uinteger) -> ConfigurationInsertStandardDesignCell
...
- **Returns** (ConfigurationInsertStandardDesignCell): Returns the specified cell if successful and null if an invalid index was specified.

### getCellByRowId(rowId: string) -> ConfigurationInsertStandardDesignCell
Gets the cell in this column at the row specified by its ID.
- **rowId** (string): The ID of the row to return the cell for.
- **Returns** (ConfigurationInsertStandardDesignCell): Returns the specified cell if successful and null if the id is not found.

### getCellByRowName(rowName: string) -> ConfigurationInsertStandardDesignCell
Gets the cell in this column at the row specified by its name.
- **rowName** (string): The name of the row to return the cell for.
- **Returns** (ConfigurationInsertStandardDesignCell): Returns the specified cell if successful and null if the name is not found.
...
### replaceDesigns : ConfigurationReplaceDesigns [read-only]
