...
**Accessed from:** Arrange3DEnvelopeDefinition.parentArrange, Arrange3DResultEnvelope.parentFeature, ArrangeComponent.parentArrangeFeature, ArrangeEnvelopeDefinition.parentArrange, ArrangeFeature.createForAssemblyContext, ArrangeFeature.nativeObject, ArrangeFeatures.add, ArrangeFeatures.item, ArrangeFeatures.itemByName, ArrangePlaneEnvelopeDefinition.parentArrange, ArrangePlaneResultEnvelope.parentFeature, ArrangeProfileOrFaceEnvelopeDefinition.parentArrange, ArrangeProfileOrFaceResultEnvelope.parentFeature, ArrangeResultEnvelope.parentFeature
...
### createForAssemblyContext(occurrence: Occurrence) -> ArrangeFeature
Creates or returns a proxy for the native object - i.e. a new object that represents this object but adds the assembly context defined by the input occurrence.
- **occurrence** (Occurrence): The occurrence that defines the context to create the proxy in.
- **Returns** (ArrangeFeature): Returns the proxy object or null if this isn't the NativeObject.
...
### arrangeStatistics : string [read-only]
...
### definition : ArrangeDefinition [read-only]
...
### nativeObject : ArrangeFeature [read-only]
