...
**Accessed from:** ConfigurationMaterialCell.parentColumn, ConfigurationMaterialColumns.add, ConfigurationMaterialColumns.item, ConfigurationMaterialColumns.itemById
...
### getCell(rowIndex: uinteger) -> ConfigurationMaterialCell
...
- **Returns** (ConfigurationMaterialCell): Returns the specified cell if successful and null if an invalid index was specified.

### getCellByRowId(rowId: string) -> ConfigurationMaterialCell
Gets the cell in this column at the row specified by its ID.
- **rowId** (string): The ID of the row to return the cell for.
- **Returns** (ConfigurationMaterialCell): Returns the specified cell if successful and null if the id is not found.

### getCellByRowName(rowName: string) -> ConfigurationMaterialCell
Gets the cell in this column at the row specified by its name.
- **rowName** (string): The name of the row to return the cell for.
- **Returns** (ConfigurationMaterialCell): Returns the specified cell if successful and null if the name is not found.
...
### parentMaterialTable : ConfigurationMaterialTable [read-only]
