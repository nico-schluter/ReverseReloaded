...
**Accessed from:** SilhouetteSplitFeature.createForAssemblyContext, SilhouetteSplitFeature.nativeObject, SilhouetteSplitFeatures.add, SilhouetteSplitFeatures.item, SilhouetteSplitFeatures.itemByName
...
### createForAssemblyContext(occurrence: Occurrence) -> SilhouetteSplitFeature
Creates or returns a proxy for the native object - i.e. a new object that represents this object but adds the assembly context defined by the input occurrence.
- **occurrence** (Occurrence): The occurrence that defines the context to create the proxy in.
- **Returns** (SilhouetteSplitFeature): Returns the proxy object or null if this is not the NativeObject.
...
### nativeObject : SilhouetteSplitFeature [read-only]
...
### operation : SilhouetteSplitOperations [read-only]
