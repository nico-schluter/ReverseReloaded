...
**Accessed from:** ConfigurationAppearanceTable.parentTableColumn, ConfigurationCustomThemeTable.parentTableColumn, ConfigurationMaterialTable.parentTableColumn, ConfigurationPlasticRuleTable.parentTableColumn, ConfigurationSheetMetalRuleTable.parentTableColumn, ConfigurationThemeCell.parentColumn
...
### getCell(rowIndex: uinteger) -> ConfigurationThemeCell
...
- **Returns** (ConfigurationThemeCell): Returns the specified cell if successful and null if an invalid index was specified.

### getCellByRowId(rowId: string) -> ConfigurationThemeCell
Gets the cell in this column at the row specified by its ID.
- **rowId** (string): The ID of the row to return the cell for.
- **Returns** (ConfigurationThemeCell): Returns the specified cell if successful and null if the id is not found.

### getCellByRowName(rowName: string) -> ConfigurationThemeCell
Gets the cell in this column at the row specified by its name.
- **rowName** (string): The name of the row to return the cell for.
- **Returns** (ConfigurationThemeCell): Returns the specified cell if successful and null if the name is not found.
...
### referencedTable : ConfigurationTable [read-only]
