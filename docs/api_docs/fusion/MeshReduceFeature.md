...
**Accessed from:** MeshReduceFeature.createForAssemblyContext, MeshReduceFeature.nativeObject, MeshReduceFeatures.add, MeshReduceFeatures.item, MeshReduceFeatures.itemByName
...
### createForAssemblyContext(occurrence: Occurrence) -> MeshReduceFeature
Creates or returns a proxy for the native object - i.e. a new object that represents this object but adds the assembly context defined by the input occurrence.
- **occurrence** (Occurrence): The occurrence that defines the context to create the proxy in.
- **Returns** (MeshReduceFeature): Returns the proxy object or null if this isn't the NativeObject.
...
### facecount : ModelParameter [read-only]
...
### maximumDeviation : ModelParameter [read-only]
...
### nativeObject : MeshReduceFeature [read-only]
...
### proportion : ModelParameter [read-only]
