...
**Accessed from:** SketchControlPointSpline.createForAssemblyContext, SketchControlPointSpline.nativeObject, SketchControlPointSplines.add, SketchControlPointSplines.item

## Methods

### addControlPoint(parameter: double) -> boolean
...
- **Returns** (boolean): Returns true if adding the control point was successful.
...
### createForAssemblyContext(occurrence: Occurrence) -> SketchControlPointSpline
Creates or returns a proxy for the native object - i.e. a new object that represents this object but adds the assembly context defined by the input occurrence.
- **occurrence** (Occurrence): The occurrence that defines the context to create the proxy in.
- **Returns** (SketchControlPointSpline): Returns the proxy object or null if this isn't the NativeObject.
...
### controlFrameLines : array [read-only]
...
### degree : SplineDegrees [read-write]
...
### isControlFrameDisplayed : boolean [read-write]
...
### nativeObject : SketchControlPointSpline [read-only]
...
The sketch point at the start of the spline. If the curve is closed the start and end sketch points will be the same.
