...
**Accessed from:** ConfigurationMaterialColumn.getCell, ConfigurationMaterialColumn.getCellByRowId, ConfigurationMaterialColumn.getCellByRowName
...
### parentColumn : ConfigurationMaterialColumn [read-only]
