...
**Accessed from:** ThickenFeature.createForAssemblyContext, ThickenFeature.nativeObject, ThickenFeatures.add, ThickenFeatures.item, ThickenFeatures.itemByName
...
### createForAssemblyContext(occurrence: Occurrence) -> ThickenFeature
Creates or returns a proxy for the native object - i.e. a new object that represents this object but adds the assembly context defined by the input occurrence.
- **occurrence** (Occurrence): The occurrence that defines the context to create the proxy in.
- **Returns** (ThickenFeature): Returns the proxy object or null if this is not the NativeObject.
...
### setInputEntities(inputFaces: ObjectCollection, isChainSelection: boolean) -> boolean
...
### inputFaces : ObjectCollection [read-write]
...
### nativeObject : ThickenFeature [read-only]
...
### thickenType : ThickenTypes [read-write]
