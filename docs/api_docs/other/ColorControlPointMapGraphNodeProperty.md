# ColorControlPointMapGraphNodeProperty
...
### addPoint(parameter: double, value: Color, interpolator: ControlPointInterpolators) -> boolean
Add a point to the map.
- **parameter** (double): Where in the input domain where the point lies.
- **value** (Color): The color value of the parameter in the output domain.
...
### getPoint(index: uinteger) -> ColorControlPoint
Get the point at index.
- **index** (uinteger): Index of the point to get.
- **Returns** (ColorControlPoint): The control point at this index.
